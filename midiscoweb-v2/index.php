...
$rutasFicheros = [
    "VerFicheros" => "ctlFileVerFicheros", //OK Profe
    "Nuevo"       => "ctlFileNuevo", //OK
    "Borrar"      => "ctlFileBorrar", //OK
    "Renombrar"   => "ctlFileRenombrar", //OK
    "Compartir"   => "ctlFileCompartir", //OK
    "Cerrar"      => "ctlUserCerrar", //OK
    "Descargar"   => "ctlFileDescargar" //OK
];
